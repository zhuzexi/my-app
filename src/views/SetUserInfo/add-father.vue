<template>
	<div class="formbg">
		...
		<m-header :mTitle="'第二步：添加直系亲属（父亲）'"></m-header>
			...
			<div class="login-page">
				<div class="login-wrap">
					...
					<div class="login-text">
						...
						<b style="color: #ee0a24; display: block; margin-right: 10px;">*</b>
						
						<input @mouseenter="focusText" @mouseleave="blurText" v-model="father" type="text" autofocus="autofocus" class="father" placeholder="请填写您父亲姓名" />
						
						<i class="iconfont icon-close" data-close="father" v-show="!fatherClose" @click="clearText"></i>
				...
				<!-- <button class="login-button" :class="{ active: removeSpace(father) && removeSpace(birthplace) && removeSpace(detailedAddress) }" @click="next">下一步</button> -->
...
export default {
	...
	methods: {
		...
		onAreaConfirm(value) {
			...
			console.log(this.provinceAndCity, '...provinceAndCity');
		...
		async next() {
			...
			params.memberInfo = [
				{
					memberName: this.father.trim(), //父亲姓名
					sex: 1,
					surnames: '', //别名
					isMarriage: 0, //婚姻状态
					isLiving: 0, //是否在世
...
.formbg::after{
	content: "";
	background: url(../../assets/addbg/addbg2.png) no-repeat;
