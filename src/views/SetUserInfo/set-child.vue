<template>
	<div class="formbg">
		<m-header :mTitle="'第四步：添加直系亲属（子女）'"></m-header>
			...
			<div class="login-page">
				<div class="login-wrap">
					...
					<div class="login-text">
						...
						<input @mouseenter="focusText" @mouseleave="blurText" v-model="child" type="text" autofocus="autofocus" class="child" placeholder="请填写您子女姓名" />
						<i class="iconfont icon-close" data-close="child" v-show="!childClose" @click="clearText"></i>
					</div>
				...
				<!-- <button class="login-button" :class="{ active: removeSpace(child) && removeSpace(birthplace) && removeSpace(detailedAddress) }" @click="next">下一步</button> -->
...
export default {
	...
	methods: {
		...
		async next() {
			...
			params.memberInfo = [
				{
					memberName: this.child.trim(), //子女姓名
...
.formbg::after{
	content: "";
	background: url(../../assets/addbg/addbg4.png) no-repeat;
